//
// Created by Austin on 4/18/2019.
//

#ifndef BINARY_BST312_H
#define BINARY_BST312_H

#endif //BINARY_BST312_H
...
private:
    ...
    void preOrderIterative(TreeNode* t) const;
...
void BST_312 <ItemType>::insertItem(TreeNode*& t, const ItemType& newItem)
{
    ...
    }else if((t->left == NULL && t->right == NULL) || (t->right == NULL && newItem > t->data) || (t->left == NULL && newItem < t->data)) //make new node if next place to go to is null
    {
        if(t->data < newItem)
        {
            t->right = new TreeNode {newItem, NULL, NULL};
        }else{
            t->left = new TreeNode {newItem, NULL, NULL};
        }
...
template<class ItemType>
void BST_312<ItemType>::preOrderIterative(BST_312::TreeNode *t) const {
    if(root == NULL)
    {
        return;
    }
